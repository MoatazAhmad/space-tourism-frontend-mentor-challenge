...
const destinationsData = [
  {
    name: "moon",
    // destImgSrc: "../assets/imgs/Destination - A - Moon.png",
  ...
  {
    name: "mars",
    // destImgSrc: "../assets/imgs/Destination - B - Mars.png",
  ...
  {
    name: "europa",
    // destImgSrc: "../assets/imgs/Destination - D - Titan.png",
  ...
  {
    name: "titan",
    // destImgSrc: "../assets/imgs/Destination - C - Europa.png",
...
provide("destinationsData", destinationsData);
provide("crewData", crewData);
provide("technologyData", technologyData);
</script>
